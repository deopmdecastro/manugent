-- 20260806060000_operational_improvements.sql
-- Mirrors docker/postgres/init/019_operational_improvements.sql, adaptada ao Supabase (roles anon/authenticated).
