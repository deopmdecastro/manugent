        ...
        <div style={{ display: 'flex', gap: 6, marginBottom: 24, justifyContent: 'center' }}>
          {(['admin','gestor','tecnico','cliente'] as const).map(role => (
            <button
              ...
              style={{ cursor: 'pointer', padding: '6px 12px', fontSize: 12, background: email.includes(role) ? undefined : 'rgba(99,102,241,0.06)', border: email.includes(role) ? undefined : '1px solid var(--border)', transition: 'all 0.2s ease' }}
