  ...
  return (
    <div className="admin-section">
      ...
      <div className="admin-cards-grid">
        {langs.map(l => (<div key={l.code} className="glass-card" style={{ padding: 20 }}>
