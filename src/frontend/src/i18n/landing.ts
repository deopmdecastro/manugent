...
export const landingTranslations: Record<Language, LandingTranslations> = {
  ...
  en: {
    nav: {
      ...
      resources: [
        { label: 'Documentation', desc: 'Guides and API reference', href: '#' },
        { label: 'Blog', desc: 'News and best practices', href: '#' },
        { label: 'Success stories', desc: 'Customer stories', href: '#' },
        { label: 'Help center', desc: 'Support and FAQs', href: '#' },
      ],
      login: 'Sign in',
      cta: 'Start for free',
      menuLabel: 'Menu',
